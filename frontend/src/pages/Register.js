      ...
      <p className="text-3xl font-bold mt-4 text-slate-950" >Sign Up</p>
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-y-3">
            <label for='full_name' className="border-transparent">
              <input type='text' className='w-2/3 h-8 rounded border border-zinc-200 p-px ps-2.5 inline-block relative text-slate-500' id='full_name' placeholder="Full Name" name="full_name" autoFocus/>
              </label>
            <label for='username'><input type='text' className='w-2/3 h-8 rounded border border-zinc-200 p-px ps-2.5 inline-block relative text-slate-500' id='username' placeholder="Username" name="username"/></label>
            <label for='email'><input type='email' className='w-2/3 h-8 rounded border border-zinc-200 p-px ps-2.5 inline-block relative text-slate-500' id='email'placeholder="Email" name="email"/></label>
            ...
            <label for='password2'><input type="password" className='w-2/3 h-8 rounded border border-zinc-200 p-px ps-2.5 inline-block relative text-slate-500' id='password2' placeholder="Retype Password" name="password2"/></label>
